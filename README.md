...
│
├── docs/
│ └── photos/ # Images and assembly documentation
│
├── firmware/
│ ├── arduino/ # Arduino source code
│ └── raspberrypi/ # Python or C code for Raspberry Pi
│
├── hardware/
│ ├── datasheets/ # Reference datasheets (HT16K33, display)
│ ├── gerber/ # PCB fabrication-ready Gerber files
│ ├── i2c-7segment-display/ # KiCad schematic & PCB files
│ └── library/
│ └── symbols/ # Custom HT16K33 symbol for KiCad
│
